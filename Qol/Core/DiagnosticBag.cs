...
namespace Qol.Core
{
    internal sealed class DiagnosticBag : IEnumerable<Diagnostic>
    {
        ...
        {
            var message = $"main must not take arguments and return void";
            Report(location, message);
        }
        ...
        {
            var message = $"Only assignment, call expressions can be used as a statement.";
            Report(location, message);
        }
        ...
        {
            var message = $"Global variables are no longer available with main function";
            Report(location, message);
        }

        public void ReportInvalidReturnWithGlobalStatements(TextLocation location)
        {
        ...
        public void ReportRequiredTypeNotFound(string qolName, string metadataName)
        {
            var message = qolName == null
                ? $"The required type '{metadataName}' cannot be resolved among the given references."
                : $"The required type '{qolName}' ('{metadataName}') cannot be resolved among the given references.";
            Report(default, message);
        }

        public void ReportRequiredTypeAmbiguous(string qolName, string metadataName, TypeDefinition[] foundTypes)
        {
            ...
            var message = qolName == null
                ...
                : $"The required type '{qolName}' ('{metadataName}')  was found in multiple references: {assemblyNameList}.";
            Report(default, message);
        }
        ...
        public void ReportRequiredMethodNotFound(string typeName, string methodName, string[] parameterTypeNames)
        {
            ...
            var message = $"The required method '{typeName}.{methodName}({parameterTypeNamesList})' cannot be resolved among the given references.";
