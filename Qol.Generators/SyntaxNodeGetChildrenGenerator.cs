...
namespace Qol.Generators
{
    ...
    public class SyntaxNodeGetChildrenGenerator : ISourceGenerator
    {
        ...
        public void Execute(SourceGeneratorContext context)
        {
            ...
            var separatedSyntaxListType = compilation.GetTypeByMetadataName("Qol.Core.Syntax.SeparatedSyntaxList`1");
            var syntaxNodeType = compilation.GetTypeByMetadataName("Qol.Core.Syntax.SyntaxNode");
            ...
            using (var indentedTextWriter = new IndentedTextWriter(stringWriter, "    "))
            {
                ...
                indentedTextWriter.WriteLine("namespace Qol.Core.Syntax");
                indentedTextWriter.WriteLine("{");
